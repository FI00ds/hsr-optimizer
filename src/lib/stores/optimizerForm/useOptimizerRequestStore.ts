...
export const useOptimizerRequestStore = createTabAwareStore<OptimizerRequestStore>((set) => ({
  ...
  setTeammateField: (index, key, value) =>
    set((state) => {
  ...
  setMainCharacterConditional: (condType, key, value) => set((state) => computeSetMainCharacterConditional(state, condType, key, value)),

  setTeammateConditional: (teammateIndex, condType, key, value) => set((state) => computeSetTeammateConditional(state, teammateIndex, condType, key, value)),
